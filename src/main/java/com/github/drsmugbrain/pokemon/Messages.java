...
public enum Messages {
    ...
    DRAIN("Drain", "%s had its energy drained!") {
        @Override
        public String getMessage(Pokemon user, Pokemon target, Battle battle, Trainer trainer, Move move, Item item, Ability ability, Stat[] stat, Status status, VolatileStatus volatileStatus, boolean self) {
