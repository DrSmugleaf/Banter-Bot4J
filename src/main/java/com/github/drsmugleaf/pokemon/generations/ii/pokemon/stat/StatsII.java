package com.github.drsmugleaf.pokemon.generations.ii.pokemon.stat;
...
import com.github.drsmugleaf.pokemon.generations.ii.pokemon.IBattlePokemonII;
import org.jetbrains.annotations.Contract;

/**
 * Created by DrSmugleaf on 09/11/2019
 */
public enum StatsII implements IBaseStat<IBattlePokemonII> {

    HP("HP", "HP", true) {
        @Override
        public int calculate(IBattlePokemonII pokemon) {
