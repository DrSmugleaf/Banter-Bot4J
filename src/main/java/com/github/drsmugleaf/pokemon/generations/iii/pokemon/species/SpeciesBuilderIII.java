 ...
 */
public class SpeciesBuilderIII<T extends BaseSpeciesIII<T>> extends SpeciesBuilder<T, SpeciesBuilderIII<T>> implements ISpeciesBuilderIII<T, SpeciesBuilderIII<T>>, IBuilder<SpeciesBuilderIII<T>> {
    ...
    public SpeciesBuilderIII<T> setEvolutions(Collection<T> evolutions) {
        this.evolutions = new SpeciesRegistryIII<>(evolutions);
        return this;
    }
