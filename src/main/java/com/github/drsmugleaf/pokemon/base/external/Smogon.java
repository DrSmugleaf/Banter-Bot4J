...
import com.github.drsmugleaf.pokemon.base.format.Format;
...
import com.github.drsmugleaf.pokemon.base.pokemon.type.TypeBuilder;
import com.github.drsmugleaf.pokemon.generations.ii.item.IItem;
import com.github.drsmugleaf.pokemon.generations.ii.item.Item;
...
import com.github.drsmugleaf.pokemon.generations.iii.pokemon.stat.nature.Nature;
...
public class Smogon {
    ...
    public Map<String, INature> getNatures() {
        ...
        for (int i = 0; i < naturesArray.length(); i++) {
            ...
            Map<IStatType, Double> multipliers = new HashMap<>();
